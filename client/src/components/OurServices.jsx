        ...
        <div className="row">
          <div className="col-md-6 d-flex" data-aos="fade-right">
            <div className="card">
              ...
              <div className="card-body">
                <h5 className="card-title"><a href="">Planning</a></h5>
                <p className="card-text">Suggesting a best place and Selecting it  on the bassis of User's prefered parameters </p>
              </div>
            </div>
          </div>
          <div className="col-md-6 d-flex" data-aos="fade-left">
            <div className="card">
              ...
              <div className="card-body">
                <h5 className="card-title"><a href="">Booking</a></h5>
                <p className="card-text">Recommending Sutaiable Lodging and Boarding Options.</p>
              </div>
            </div>
