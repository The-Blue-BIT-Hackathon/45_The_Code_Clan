...
//             (item) => (
//               <MDBRow
//                 className="justify-content-center mb-0 d-flex flex-wrap"
...
const oneplace = JSON.parse(localStorage.getItem("oneplace"));
console.log("oneplace", localStorage.getItem("oneplace"));
...
const PlaceResult = () => {
  ...
  let city = oneplace.context.city;
  ...
  const options = {
    ...
    headers: {
      "X-RapidAPI-Key": "2368867a41mshc64e1810cd41fc1p179f6bjsnc5c4c7580e2c",
      "X-RapidAPI-Host": "travel-advisor.p.rapidapi.com",
    },
  };
  ...
  return (
    <>
      ...
      <section className="Output">
        <div className="placename">
          <div className="nameHeading text-center">
            {oneplace.context?.name}
          </div>
          <div className="descp">{oneplace.context?.description}</div>
        </div>

        <div className="palceImage">
          <div className="photo">
            <img src={`${oneplace.context?.url}`} alt="" />
          </div>
        </div>
      </section>
